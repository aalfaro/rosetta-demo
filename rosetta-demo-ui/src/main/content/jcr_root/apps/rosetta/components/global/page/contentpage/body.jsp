...
<body>
    ...
    <cq:include path="masthead" resourceType="demo/components/global/content/masthead"/>
    <cq:include path="content" script="content.jsp"/>
    <cq:include path="footer" resourceType="demo/components/global/content/footer"/>
